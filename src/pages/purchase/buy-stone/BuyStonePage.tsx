			...
			<div className="max-w-xl mx-auto mt-10 px-4">
				...
				<Card shadow="sm" radius="lg" mt="md" padding="lg">
					...
					<Text size="sm" c="dimmed" mb="md">
						Nạp nhiều linh thạch giúp bạn mở khoá các đặc quyền như: đọc chương
						VIP, giảm giá khi mua truyện, ưu tiên truy cập nội dung mới và nhiều
						quyền lợi khác trong tương lai.
					</Text>
					...
					<div className="rounded-lg border border-yellow-300 bg-yellow-50 dark:bg-yellow-900/20 p-3">
						...
						<ul className="list-disc list-inside space-y-1 text-sm text-gray-700 dark:text-gray-300">
							...
							<li>
								Nếu sau khi thanh toán mà chưa nhận được linh thạch, vui lòng
								liên hệ hỗ trợ và cung cấp <b>mã giao dịch</b>
							</li>
						</ul>
					</div>
				</Card>
